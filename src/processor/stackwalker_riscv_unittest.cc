...
StackwalkerRISCV walker(&system_info, &raw_context, &stack_region, &modules,
                        &frame_symbolizer);
...
class GetFramesByFramePointer: public StackwalkerRISCVFixture, public Test { };
...
StackFrameRISCV::CONTEXT_VALID_PC | StackFrameRISCV::CONTEXT_VALID_SP;
raw_context.pc = 0x40004001;
raw_context.s0 = 0xbe145fc4;
